%% TOTAL UNCERTAINTY BLOCK
openloop_model_noweights;
Design_model_stab=ulinearize('openloop_model_noweights');
%% STABILITY TOTAL

CL_muanalysis2 = lft(Design_model_stab,K_lpv);  
...
% THIS IS THE FASTEST OPTION, WE DON'T CARE ABOUT LOWER BOUNDS
% opts = robOptions('Display','on','Sensitivity','off','MussvOptions','ag9');
% opts = robOptions('Display','on','Sensitivity','off','MussvOptions','fg9');
N_freq=250;
...
%% PERFORMANCE FULL UNCERTAINTY BLOCK
