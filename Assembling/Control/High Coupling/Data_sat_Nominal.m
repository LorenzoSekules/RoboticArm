...
m_B =       4000;     % [kg] Mass central body
m_B_SIM =   4000;  % [kg] Mass central body (used in simscape)

J_B_Bxx = 0; % [kg*m^2] Moment of inertia (xx) of the central body B
J_B_Byy = 0; % [kg*m^2] Moment of inertia (yy) of the central body B
J_B_Bzz = 0; % [kg*m^2] Moment of inertia (zz) of the central body B
J_B_Bxy =       0;  %  [kg*m^2] Cross moment of inertia (xy) of the central body B
J_B_Byz =      0; %  [kg*m^2] Cross moment of inertia (yz) of the central body B
J_B_Bxz =       0;   %  [kg*m^2] Cross moment of inertia (xz) of the central body B
...
CoM_variation_x = 0; % Less than 10-15 mm (x-y) except the launcher axis (around 20 mm)
CoM_variation_y = 0;
CoM_variation_z = 0;
...
m_C =       100;     % [kg] Mass central body

J_C_Cxx = m_C/12*(Container_y^2+Container_z^2); % [kg*m^2] Moment of inertia (xx) of the central body B
J_C_Cyy = m_C/12*(Container_x^2+Container_z^2); % [kg*m^2] Moment of inertia (yy) of the central body B
J_C_Czz = m_C/12*(Container_y^2+Container_x^2); % [kg*m^2] Moment of inertia (zz) of the central body C
J_C_Cxy =       0;  %  [kg*m^2] Cross moment of inertia (xy) of the central body B
J_C_Cyz =       0; %  [kg*m^2] Cross moment of inertia (yz) of the central body B
J_C_Cxz =       0;   %  [kg*m^2] Cross moment of inertia (xz) of the central Cody B
...
m_P =      50;     % [kg] Mass central body

J_P_Pxx = m_P/12*(Brick_y^2+Brick_z^2); % [kg*m^2] Moment of inertia (xx) of the central body B
J_P_Pyy = m_P/12*(Brick_x^2+Brick_z^2); % [kg*m^2] Moment of inertia (yy) of the central body B
J_P_Pzz = m_P/12*(Brick_y^2+Brick_x^2); % [kg*m^2] Moment of inertia (zz) of the central body C
J_P_Pxy =       0;  %  [kg*m^2] Cross moment of inertia (xy) of the central body B
J_P_Pyz =       0; %  [kg*m^2] Cross moment of inertia (yz) of the central body B
J_P_Pxz =       0;   %  [kg*m^2] Cross moment of inertia (xz) of the central Cody B
...
for i = 1:numel(activeLinks)
        ...
        robot.linkMass{i} = rho_arm * pi * r_cyl^2 * L_cyl;


        J_xx = robot.linkMass{i} / 12 * (3 * r_cyl^2 + L_cyl^2);
        J_yy = robot.linkMass{i} / 12 * (3 * r_cyl^2 + L_cyl^2);
        J_zz = robot.linkMass{i} / 2  * (r_cyl^2);
...
% --- UNCERTAIN MASS ---
m_T =        m_nominal;     % [kg] Mass central body

% --- UNCERTAIN MOMENTS OF INERTIA ---
% For a regular hexagonal prism with flat face in XY plane, extruded along Z
J_T_Txx = m_T * ( (5/24)*(Tile_s^2) + (1/12)*(Tile_z^2) ); % [kg*m^2] Moment of inertia (xx)
J_T_Tyy = m_T * ( (5/24)*(Tile_s^2) + (1/12)*(Tile_z^2) ); % [kg*m^2] Moment of inertia (yy)
J_T_Tzz = m_T * (5/12)*(Tile_s^2);                         % [kg*m^2] Moment of inertia (zz)

% --- UNCERTAIN CROSS MOMENTS OF INERTIA ---
% Symmetrical regular hexagons have nominal cross inertias of 0
J_T_Txy =       0;  % [kg*m^2] Cross moment of inertia (xy)
J_T_Tyz =       0;  % [kg*m^2] Cross moment of inertia (yz)
J_T_Txz =       0;  % [kg*m^2] Cross moment of inertia (xz)
