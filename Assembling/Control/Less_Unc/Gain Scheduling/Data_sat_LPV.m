...
if exist('q_i', 'var')
    ...
    error('No linearization point detected')
end

q_err_up = deg2rad(10*ones(7,1));
q_err_low = deg2rad(-10*ones(7,1));
...
if UNC_JOINTS
    ...
    robot.config = { ...
        ureal('Q_1', q_nominale(1), 'Range', [q_nominale(1)+q_err_low(1) q_nominale(1)+q_err_up(1)], 'AutoSimplify', 'full'), ...
        ureal('Q_2', q_nominale(2), 'Range', [q_nominale(2)+q_err_low(2) q_nominale(2)+q_err_up(2)], 'AutoSimplify', 'full'), ...
        ureal('Q_3', q_nominale(3), 'Range', [q_nominale(3)+q_err_low(3) q_nominale(3)+q_err_up(3)], 'AutoSimplify', 'full'), ...
        ureal('Q_4', q_nominale(4), 'Range', [q_nominale(4)+q_err_low(4) q_nominale(4)+q_err_up(4)], 'AutoSimplify', 'full'), ...
        ureal('Q_5', q_nominale(5), 'Range', [q_nominale(5)+q_err_low(5) q_nominale(5)+q_err_up(5)], 'AutoSimplify', 'full'), ...
        ureal('Q_6', q_nominale(6), 'Range', [q_nominale(6)+q_err_low(6) q_nominale(6)+q_err_up(6)], 'AutoSimplify', 'full'), ...
        ureal('Q_7', q_nominale(7), 'Range', [q_nominale(7)+q_err_low(7) q_nominale(7)+q_err_up(7)], 'AutoSimplify', 'full') ...
    };
else
