...
K_Full_Matrix0 = K_10DOF_Tuned.D; 
...
K_LPV = tunableSurface('K_LPV',ones(10,30),domain,shapefcn);
% Mantiene la struttura [Kp | Ki | Kd] e previene il cross-windup integrale
Free_Kp = true(10, 10);
Free_Ki = blkdiag(true(3,3), true(7,7));
Free_Kd = true(10, 10);

K_LPV.Free = [Free_Kp, Free_Ki, Free_Kd];
K_LPV.Gain.Value = K_Full_Matrix0;
...
save('K_10DOF_LPV_gridded_v2.mat',...
    'CL_LPV_Tuned','K_LPV_opt','fSoft','gHard','Info',...
